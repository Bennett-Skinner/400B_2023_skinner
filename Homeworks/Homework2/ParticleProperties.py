...
def ParticleInfo(filename, particle_type, particle_number):
    ...
    mass = float(data['m'][index])*u.solMass # Get mass of the particle (given in solar masses)
...
dist, vel, mass = ParticleInfo('MW_000.txt',2.0,100)
print("Distance: " + str(dist))
print("Velocity: " + str(vel))
print("Mass: " + str(mass))
print("Distance (lyr): " + str(np.around(dist.to(u.lyr),3)))